...
| 2 | Core content: theory + main topologies (EN, then KO) | in progress: 02-theory and 03-topologies done (EN + KO); 00/01 refreshers next |
...
| 2 | 핵심 콘텐츠: 이론 + 주요 토폴로지 (영어 후 한국어) | 진행 중: 02-이론·03-토폴로지 완료(영어·한국어); 00/01 기초 복습 예정 |
